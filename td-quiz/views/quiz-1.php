<section class="quiz-forms">
	<div class="row justify-content-md-center">
		<div class="col-12 col-sm-9 col-md-6 col-lg-4 mx-auto animated fadeInDown visible" data-animation="fadeInDown" data-animation-delay="100">
			<div id="quiz-status" data-percent="19" class="skillbar-status">
    ...
    <form action="" method="post" id="quiz-1" class="quiz-form">
            ...
            if(!$quiz_list){
                ...
                foreach($quiz_list as $quiz){
                    ...
                    if($cat_name == 'Aspirant' || $cat_name == 'Subordinate'){
                        $cat_name = 'Aspirant and Subordinate';
                    }*/
		...
		<div class="row justify-content-center">
			<div class="col-md-12">
                <div class="text-center margin-top">
                    <button data-animation="flipInY" data-animation-delay="800" class="btn btn-quiz submit-button animated flipInY visible" id="quiz_next" data-step="2" type="submit">Next &#8594;</button>
                </div>
            </div>
        </div>
	</form>
