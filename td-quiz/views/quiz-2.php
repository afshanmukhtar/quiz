<section class="quiz-forms">
	<div class="row justify-content-center">
		<div class="col-12 col-sm-9 col-md-6 col-lg-4 mx-auto animated fadeInDown visible" data-animation="fadeInDown" data-animation-delay="100">
			<div id="quiz-status" data-percent="40" class="skillbar-status">
    ...
    <form action="" method="post" id="quiz-2" class="quiz-form">
		<div class="row justify-content-center">
		...
		<div class="row justify-content-center">
			<div class="col-md-12">
                <div class="text-center margin-top">
                    <button data-animation="flipInY" data-animation-delay="800" class="btn btn-quiz submit-button animated flipInY visible" id="quiz_next" data-step="3" type="submit">Next &#8594;</button>
                    <!--<button data-animation="flipInY" data-animation-delay="800" class="btn btn-quiz submit-button animated flipInY visible" type="submit">Finish &#8594;</button>-->
                </div>
            </div>
        </div>
	</form>
