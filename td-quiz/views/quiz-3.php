<section class="quiz-forms">
	<div class="row justify-content-center">
		<div class="col-12 col-sm-9 col-md-6 col-lg-4 mx-auto animated fadeInDown visible" data-animation="fadeInDown" data-animation-delay="100">
			<div id="quiz-status" data-percent="65" class="skillbar-status">
		...
		<div class="row justify-content-center">
			<div class="col-md-12">
                <div class="text-center margin-top">
                    <button data-animation="flipInY" data-animation-delay="800" class="btn btn-quiz submit-button animated flipInY visible" id="quiz_next" data-step="4" type="submit">Next &#8594;</button>
                </div>
            </div>
        </div>
	</form>
